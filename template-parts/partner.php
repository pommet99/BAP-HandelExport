...
<div>
    <div class="containerintro">
        <img class="flogo" src="<?php echo get_template_directory_uri(); ?>/photos/PARTENAIRE_IMAGE.png" style="max-width: 100%">
        <div class="text">
            <h1 class="firsth1">PARTENAIRES</h1>
            <div class="rectangle"></div>
        </div>
    </div>

    <div class="containerpartner">
        <div id="rectanglepartner">IMPORTATEUR</div>
        <div id="rectanglepartner2">
            <ul class="flex-container-import">
                <li>
                    <img class="partnerlogo" src="<?php echo get_template_directory_uri(); ?>/photos/partner/starmix.png" style="max-width: 240px; margin-top: -20px; padding: 0 50px 0 50px">
                </li>
                <li>
                    <img class="partnerlogo" src="<?php echo get_template_directory_uri(); ?>/photos/partner/flamic.png" style="max-width: 240px; max-height: 100px;  padding: 0 50px 0 50px    ">
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="containerpartner2">
        <h1>Partenaires étrangers</h1><br>
        <div class="rectanglepartner"></div>
    </div>
    <div class="containerpartner3">
        <ul class="flex-container-partner">
            <li>
                <img class="partnerlogo" src="<?php echo get_template_directory_uri(); ?>/photos/partner/2/Bormioli%20Rocco.png" style="max-width: 250px; padding: 50px">
            </li>
            <li>
                <img class="partnerlogo" src="<?php echo get_template_directory_uri(); ?>/photos/partner/2/yesovens.png" style="max-width: 250px; padding: 50px">
            </li>
            <li>
                <img class="partnerlogo" src="<?php echo get_template_directory_uri(); ?>/photos/partner/2/rational.png" style="max-width: 250px; padding: 50px">
            </li>
            <li>
                <img class="partnerlogo" src="<?php echo get_template_directory_uri(); ?>/photos/partner/2/liebherr.png" style="max-width: 250px; padding: 50px">
            </li>
            <li>
                <img class="partnerlogo" src="<?php echo get_template_directory_uri(); ?>/photos/partner/2/animo.png" style="max-width: 250px; padding: 50px">
            </li>
            <li>
                <img class="partnerlogo" src="<?php echo get_template_directory_uri(); ?>/photos/partner/2/pujadas.png" style="max-width: 250px; padding: 50px">
            </li>
            <li>
                <img class="partnerlogo" src="<?php echo get_template_directory_uri(); ?>/photos/partner/2/Ohaus.jpg" style="max-width: 250px; padding: 50px">
            </li>
            <li>
                <img class="partnerlogo" src="<?php echo get_template_directory_uri(); ?>/photos/partner/2/salamandre-professionelle-4-kw-lacor.png" style="max-width: 250px; padding: 50px">
            </li>
            <li>
                <img class="partnerlogo" src="<?php echo get_template_directory_uri(); ?>/photos/partner/2/amefa%20(2).jpg" style="max-width: 250px; padding: 50px">
            </li>
            <li>
                <img class="partnerlogo" src="<?php echo get_template_directory_uri(); ?>/photos/partner/2/LOGO-HORIZONTAL-NOIR%20(2).jpg" style="max-width: 250px; padding: 50px">
            </li>
            <li>
                <img class="partnerlogo" src="<?php echo get_template_directory_uri(); ?>/photos/partner/2/mapal.png" style="max-width: 250px; padding: 50px">
            </li>
        </ul>
    </div>
</div>
